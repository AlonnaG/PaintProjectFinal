...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        ColorPicker cpFill = new ColorPicker(Color.BLACK);
        ...
        btns.getChildren().addAll(drawBtn, lineBtn, rectBtn, circleBtn, ovalBtn, eraseBtn, textBtn, text, line_color, lineColor, fill_color, cpFill, line_width, slider, undo, redo, open, save);
