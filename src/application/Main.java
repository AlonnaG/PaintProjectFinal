...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        ToggleButton[] toolsArr = {drawBtn, lineBtn, ERASEBtn, rectBtn, circleBtn, ovalBtn, textBtn};
        ...
        btns.getChildren().addAll(drawBtn,  lineBtn, rectBtn, circleBtn, ovalBtn, textBtn, ERASEBtn, text, line_color, cpLine, fill_color, cpFill, line_width, slider, undo, redo, open, save);
        ...
        canvas.setOnMouseDragged(e->{
            if(drawBtn.isSelected()) {
            	...
            	/*line.setEndX(e.getX());
                	line.setEndY(e.getY());
                	line.relocate(line.getEndX(), line.getEndY());
                ...
                for (int i = 0; i < lines.length; i++) 
                {
                    ...
                    //lines[i] = (new Line(line.getStartX(), line.getStartY(), line.getEndX(), line.getEndY()));
                    //gc.lineTo(e.getX(), e.getY());
                  }  
                   //gc.strokeLine(line.getStartX(), line.getStartY(), line.getEndX(), line.getEndY());
                */    
        ...
        pane1.setLeft(btns);
        pane1.setCenter(canvas);
    
        Scene scene = new Scene(pane1, 1200, 800);
